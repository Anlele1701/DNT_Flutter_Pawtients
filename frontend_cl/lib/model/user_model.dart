...
class User {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    if (json['diem'] == null)
      ...
      diem = json["diem"];
    if (json['hangThanhVien'] == null)
      hangThanhVien = '';
    else
      hangThanhVien = json["hangThanhVien"];
    if (json['dsThuCung'] == null)
      dsThuCung = [];
    else
      dsThuCung = json["dsThuCung"]?.cast<String>();
    if (json['hinhAnh'] == null)
      image = null;
    else
      image = ImagePet.fromjson(json["hinhAnh"]);
    if (json['dsLichkham'] == null)
      dsLichKham = null;
    else
      dsLichKham = json["dsLichkham"]?.cast<String>();
  }
